...
export default function AdminLayout({ children }) {
  ...
  const nav = [
    ...
    { href: "/admin/orders", label: "Orders", icon: icons.orders, badge: orderCount },
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-3 py-4 space-y-5">
        ...
        {!collapsed && pendingCount > 0 && (
          ...
          >
            ...
            <p className="text-[11px] text-zinc-400 mt-1">Unfulfilled orders opore ache — ekhon e process korun</p>
          </Link>
        )}
