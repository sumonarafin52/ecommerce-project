...
export default function AdminLayout({ children }) {
  ...
  const nav = [
    ...
    { href: "/admin/products", label: "Products", icon: icons.products, perm: "products" },
    ...
    <div className="bg-primary min-h-screen">
      ...
      {open && (
        <div className="lg:hidden fixed inset-0 z-50">
          ...
          <aside className="absolute inset-y-0 left-0 w-72 bg-primary-light border-white/10 flex flex-col">{sidebar}</aside>
        </div>
      )}
